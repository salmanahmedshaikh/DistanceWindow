...
class IO
{
    public:
        ...
        std::unordered_map<int, std::unordered_map<std::string,  std::unordered_map < int, std::map< std::string, std::tuple<Point, std::string>>>>> buildTrajectoryFromFourSquareCSV(std::string fileName);
